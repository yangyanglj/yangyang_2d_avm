...
int main(int argc, char** argv)
{
	...
	points_top[0] = Point(0,0);
	points_top[1] = Point(im_dst.cols-1, 0);
	points_top[2] = Point(im_dst.cols/3*2, im_dst.rows/3);
	points_top[3] = Point(im_dst.cols/3, im_dst.rows/3);
