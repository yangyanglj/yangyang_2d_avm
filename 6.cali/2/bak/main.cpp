...
int main() 
{
	...
	Size board_size = Size(29,9);    /* 标定板上每行、列的角点数 */
	...
	*************************************************************************/
...
#if 0
	Mat distort_img = imread("0.JPG", 1);
	...
	fisheye::undistortImage(distort_img, undistort_img, cameraMatrix, distCoeffs, new_intrinsic_mat);
